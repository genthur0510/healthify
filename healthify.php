...
<body>
   ...
   <!-- header -->
    ...
    <!-- dokter -->
    <div class="container-healthify-dies">
                    ...
                    <div class="container">
                        <div class="card sdh2 mb-3" data-aos="fade-up" data-aos-duration="1000">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="vendor/img/doc/dc1.jpg" class="card-img mt-10" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">

                                        <h3 class="card-title">Dokter Umum</h3>
                                        <p class="card-text text-left" style="overflow: auto;">Dr. Andini Wilson</p>
                                        <img src="vendor/img/doc/star.png" width="150px" height="auto"><br><br>
                                                                                
                                    <a href="chat.php" class="btn btn-primary" data>Mulai Chat</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-sm-6 p-3">
                    <div class="container">
                        <div class="card sdh2 mb-3" data-aos="fade-up" data-aos-duration="1000">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="vendor/img/doc/dc2.jpg" class="card-img mt-10" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h3 class="card-title">Spesialis Mata</h3>
                                        <p class="card-text text-left" style="overflow: auto;">Dr. Jessica </p>
                                        <img src="vendor/img/doc/star.png" width="150px" height="auto"><br><br>
                                        <a href="chat.php" class="btn btn-primary" data>Mulai Chat</a>
                                    </div>
                                </div>
                ...
                <div class="col-sm-6 p-3">
                    <div class="container">
                        <div class="card sdh2 mb-3" data-aos="fade-up" data-aos-duration="1000">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="vendor/img/doc/dc4.jpg" class="card-img mt-10"  alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h3 class="card-title">Spesialis THT</h3>
                                        <p class="card-text text-left" style="overflow: auto;">Dr. Ray Parker</p>
                                        <img src="vendor/img/doc/star.png" width="150px" height="auto"><br><br>
                                        <a href="chat.php" class="btn btn-primary" data>Mulai Chat</a>
                                    </div>
                                </div>
            ...
            <div class="col-sm-6 p-3">
                    <div class="container">
                        <div class="card sdh2 mb-3" data-aos="fade-up" data-aos-duration="1000">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="vendor/img/doc/dc3.jpg" class="card-img mt-10" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h3 class="card-title">Spesialis Anak</h3>
                                        <p class="card-text text-left" style="overflow: auto;">Dr. Nanda Azzahra</p>
                                        <img src="vendor/img/doc/star.png" width="150px" height="auto"><br><br>
                                        <a href="chat.php" class="btn btn-primary" data>Mulai Chat</a>
                                    </div>
                                </div>
                ...
                <div class="col-sm-6 p-3">
                    <div class="container">
                        <div class="card sdh2 mb-3" data-aos="fade-up" data-aos-duration="1000">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="vendor/img/doc/dc5.jpg" class="card-img mt-10" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h3 class="card-title">Spesialis Jantung</h3>
                                        <p class="card-text text-left" style="overflow: auto;">Dr. Lee Park Wo</p>
                                        <img src="vendor/img/doc/star.png" width="150px" height="auto"><br><br>
                                        <a href="chat.php" class="btn btn-primary" data>Mulai Chat</a>
                                    </div>
                                </div>
            ...
            <div class="col-sm-6 p-3">
                    <div class="container">
                        <div class="card sdh2 mb-3" data-aos="fade-up" data-aos-duration="1000">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="vendor/img/doc/dc6.jpg" class="card-img mt-10" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h3 class="card-title">Spesialis Gigi</h3>
                                        <p class="card-text text-left" style="overflow: auto;">Dr. John Denis</p>
                                        <img src="vendor/img/doc/star.png" width="150px" height="auto"><br><br>
                                        <a href="chat.php" class="btn btn-primary" data>Mulai Chat</a>
                                    </div>
                                </div>
